...
const SinglePostDetails = ({ post }: { post: IPost }) => {
  return (
    <Card
      shadow={true}
      className="w-full flex-row h-[calc(100vh-50px)]"
      ...
      <CardBody className="relative w-full" placeholder="Card body content"  onResize={undefined} onResizeCapture={undefined} onPointerEnterCapture={undefined} onPointerLeaveCapture={undefined}>
        <section className="flex flex-col gap-10 m-8 absolute transform top-1/2 translate-y-[-50%] text-center">
          <Typography
            variant="h1"
            color="gray"
            className="mb-4 uppercase"
            placeholder="Heading"  onResize={undefined} onResizeCapture={undefined} onPointerEnterCapture={undefined} onPointerLeaveCapture={undefined}          >
