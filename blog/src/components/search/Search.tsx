  ...
  return (
    <div className="group relative w-[500px]">
      <Input
        ...
        value={query}
        onChange={handleSearch} onResize={undefined} onResizeCapture={undefined} onPointerEnterCapture={undefined} onPointerLeaveCapture={undefined} crossOrigin={undefined}        // readOnly
      />
